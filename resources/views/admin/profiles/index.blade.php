        ...
        <div class="col-12">
            <div class="card mb-4">
              <div class="card-header pb-0">
                ...
                <div class=" text-end">
                    <a class="btn bg-gradient-warning mb-0" href="{{ route('experts.createProfile') }}"><i class="fas fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;New Profile</a>
                </div>
              </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="align-middle">
                            <a class="btn btn-link text-dark px-3 mb-0" href="{{ route('experts.editProfile', $profile->id) }}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                            <form action="{{ route('experts.destroyProfile', $profile->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-link text-danger text-gradient px-3 mb-0" onclick="return confirm('Are you sure you want to delete this profile?')"><i class="far fa-trash-alt me-2" aria-hidden="true"></i>Delete</button>
                            </form>
                        </td>
                      </tr>
                      @endforeach
