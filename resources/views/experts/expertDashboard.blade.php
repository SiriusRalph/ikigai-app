...
<body class="g-sidenav-show bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" href=" {{route('expertDashboardShow')}} ">
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{route('expert.consultations')}}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="container-fluid py-4">
      ...
      <div class="row mt-4">
          ...
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              ...
              <p class="text-sm mb-0">
                <span class="font-weight-bold">Ordered by</span> month
              </p>
            </div>
            <div class="card-body p-3">
              <div class="chart">
        ...
        <div class="col-lg-5 mb-lg-0 mb-4">
            <div class="card z-index-2 h-100">
              <div class="card-header pb-0 pt-3 bg-transparent">
                <h6 class="text-capitalize">Recents consultations</h6>
              </div>
              <div class="card-body p-3">
                <ul class="list-group">
                    @foreach($recentConsultations as $consultation)
                        <li class="list-group-item">
                            <span class="font-weight-bolder text-warning ">Client:</span> {{ $consultation->user->name }},
                            <span class="font-weight-bolder text-warning ">Date:</span> {{ $consultation->created_at }},
                            <span class="font-weight-bolder text-warning ">Statut:</span> {{ $consultation->statut }}
                        </li>
                    @endforeach
                </ul>
              </div>
