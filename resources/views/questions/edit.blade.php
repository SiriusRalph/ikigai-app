                ...
                <div class="card-body">
                    <form action="{{ route('questions.update', $question->id) }}" method="POST">
                        ...
                        <div>
                            ...
                            <input class="form-control" type="text" name="question" id="question" value="{{ $question->question }}" required>
                        </div>
                        <div>
                        ...
                        <div id="options-container" style="{{ $question->type == 'select' || $question->type == 'radio' ? 'block' : 'none' }}">
                            ...
                            <input class="form-control" type="text" name="options" id="options" value="{{ implode(',', $question->options ?? []) }}">
                        </div>
                        <button class="btn bg-gradient-info w-100 my-4 mb-2" type="submit">Update Question</button>
                    </form>
                </div>
            </div>
            </div>
